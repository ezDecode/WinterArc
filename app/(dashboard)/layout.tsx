    ...
    <div className="min-h-screen bg-background">
      ...
      <div className={`fixed top-0 left-0 h-full w-80 max-w-[85vw] bg-surface border-r border-border z-50 md:hidden transform transition-transform duration-300 ease-out ${
        ...
        <div className="flex items-center justify-between p-4 border-b border-border">
          <Link 
            href="/today" 
            className="text-xl font-bold text-text-primary focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-surface rounded-lg px-2 py-1 -mx-2 -my-1"
            onClick={() => setIsMobileMenuOpen(false)}
          >
            Winter Arc
          </Link>
          <button
            onClick={() => setIsMobileMenuOpen(false)}
            className="p-2 rounded-lg text-text-secondary hover:text-text-primary hover:bg-surface-hover transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-surface"
...
function NavLink({ 
  ...
  return (
    <Link
      href={href}
      className={`px-3 sm:px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 whitespace-nowrap min-h-[44px] flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-black ${
        isActive 
          ? 'text-text-primary bg-surface-hover border border-border' 
...
function MobileNavLink({ 
  ...
  return (
    <Link
      href={href}
      className={`flex items-center gap-3 px-4 py-3 rounded-xl text-base font-medium transition-all duration-200 min-h-[52px] focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-surface animate-in slide-in-from-left-5 ${
        isActive 
