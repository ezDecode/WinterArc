      ...
      <div className="max-w-md mx-auto text-center animate-in">
        <div className={`bg-surface ${styles.border} ${styles.background} rounded-xl p-6 sm:p-8 shadow-sm`}>
          ...
          {onRetry && (
            <button
              onClick={onRetry}
              className="group inline-flex items-center gap-2 px-6 py-3 bg-purple-600 text-white rounded-xl font-medium hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-surface transition-all duration-200 hover:scale-105"
